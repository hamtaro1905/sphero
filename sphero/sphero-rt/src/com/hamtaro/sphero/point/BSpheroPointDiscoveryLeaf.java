...
/**
 * BSpheroPointDiscoveryLeaf is container class for point elements to display in
...
public class BSpheroPointDiscoveryLeaf
  extends BNPointDiscoveryLeaf
{
//region /*+ ------------ BEGIN BAJA AUTO GENERATED CODE ------------ +*/
//@formatter:off
/*@ $com.hamtaro.sphero.point.BSpheroPointDiscoveryLeaf(1643154273)1.0$ @*/
/* Generated Wed May 21 10:49:52 ICT 2025 by Slot-o-Matic (c) Tridium, Inc. 2012-2025 */
  ...
  public static final Type TYPE = Sys.loadType(BSpheroPointDiscoveryLeaf.class);

  //endregion Type

//@formatter:on
//endregion /*+ ------------ END BAJA AUTO GENERATED CODE -------------- +*/
  public BSpheroPointDiscoveryLeaf()
  {
  }
...
//    }
  ...
  public void updateTarget(BComponent target)
  {
    ...
    BSpheroProxyExt pext = new BSpheroProxyExt();
  ...
  public boolean isExisting(BComponent target)
  {
    ...
    BControlPoint cp = (BControlPoint) target;
    BSpheroProxyExt pext = (BSpheroProxyExt) cp.getProxyExt();
    //
